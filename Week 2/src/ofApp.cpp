    ...
    for (int i = 0; i < output.getNumFrames(); ++i){
      ...
      //  if(myClock.tick && ofRandom(1.0)>0.7){
       ...
       // }
        ...
        output[i * outChannels] = myOsc1.sinewave(8000)*myOsc2.sinewave(240) + myOsc3.coswave(300) + myOsc4.coswave(150);
        
        output[i * outChannels + 1] = output[i * outChannels];
       // float myOut =church.play(1+myOsc1.sinewave(18)) +celesta.playOnce(myOsc2.saw((0.14)*50));
